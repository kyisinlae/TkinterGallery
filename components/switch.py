...
#     formlable = ttk.Label(formtitle,text="Switch", font="Tahoma 15", height=1, bg="white", pady=5)
#     formlable.pack(side="top", anchor="center")
#     formdesigner = ttk.Frame(formView, background="white", padx=10,pady=10)
#     formdesigner.pack(side="top", fill="both", expand=True)
    
#     panedwindow.add(formView, weight=5)  
#     panedwindow.add(codeView, weight=2)
    
#     # switch = ttk.Checkbutton(formdesigner, text="switch", style='Switch')
    
#     scroll_v = ttk.Scrollbar(codeView)
#     scroll_v.pack(side= tk.RIGHT,fill=tk.Y)

#     #Add a Horizontal Scrollbar
#     scroll_h = ttk.Scrollbar(codeView, orient= HORIZONTAL)
...
#     text.insert(ttk.END, insert_text)
